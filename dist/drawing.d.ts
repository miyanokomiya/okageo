 ...
 * @return サイズ変更後の矩形
 */
export declare function resizeRectByLeftTop(org: IRectangle, diff: IVec2): IRectangle;
/**
 * 矩形を右上頂点からリサイズ
 * @param org 元の矩形
 * @param diff 変更ベクトル
 * @return サイズ変更後の矩形
 */
export declare function resizeRectByRightTop(org: IRectangle, diff: IVec2): IRectangle;
/**
 * 矩形を右下頂点からリサイズ
 * @param org 元の矩形
 * @param diff 変更ベクトル
 * @return サイズ変更後の矩形
 */
export declare function resizeRectByRightBottom(org: IRectangle, diff: IVec2): IRectangle;
/**
 * 矩形を左下頂点からリサイズ
 * @param org 元の矩形
 * @param diff 変更ベクトル
 * @return サイズ変更後の矩形
 */
export declare function resizeRectByLeftBottom(org: IRectangle, diff: IVec2): IRectangle;
